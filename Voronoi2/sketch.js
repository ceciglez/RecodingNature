...
function draw(){
  ...
  let voronoi = delaunay.voronoi([0,0,width,height]); // in order to calculate the Voronoi diagram we need to define a bounding box to fit all the polygons to de cells in
  let polygons = voronoi.cellPolygons(); // this returns an iterable of polygons, each polygon is an array of points
